...
//     */
//    public ExecuteScriptCommand(Writer writer, ArrayListManager listManager, HistoryStorage historyStorage){
...
//
//    /**
//     * @param firstArgument Название файла скрипта
...
//                            commands.put("update", new UpdateCommand(arrayListManager, scriptModeReader));
...
//                            commands.put("insert_at", new InsertAtCommand(arrayListManager, scriptModeReader));
